_systemInit:
;Click_3DHALL5_PIC32.c,36 :: 		void systemInit()
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Click_3DHALL5_PIC32.c,38 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_INT_PIN, _GPIO_INPUT );
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
ORI	R27, R0, 1
...
NOP	
;Click_3DHALL5_PIC32.c,39 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_CS_PIN, _GPIO_OUTPUT );
MOVZ	R27, R0, R0
ORI	R26, R0, 2
MOVZ	R25, R0, R0
JAL	_mikrobus_gpioInit+0
NOP	
;Click_3DHALL5_PIC32.c,40 :: 		mikrobus_i2cInit( _MIKROBUS1, &_C3DHALL5_I2C_CFG[0] );
LUI	R2, hi_addr(__C3DHALL5_I2C_CFG+0)
ORI	R2, R2, lo_addr(__C3DHALL5_I2C_CFG+0)
MOVZ	R26, R2, R0
MOVZ	R25, R0, R0
...
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Click_3DHALL5_PIC32.c,48 :: 		c3dhall5_i2cDriverInit( (T_C3DHALL5_P)&_MIKROBUS1_GPIO, (T_C3DHALL5_P)&_MIKROBUS1_I2C, 0x1E );
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
ORI	R27, R0, 30
...
JAL	_mikrobus_logWrite+0
NOP	
;Click_3DHALL5_PIC32.c,69 :: 		temp = c3dhall5_temperature();
JAL	_c3dhall5_temperature+0
NOP	
SW	R2, Offset(_temp+0)(GP)
;Click_3DHALL5_PIC32.c,70 :: 		mikrobus_logWrite(" Temp : ", _LOG_TEXT);
ORI	R26, R0, 1
LUI	R25, hi_addr(?lstr5_Click_3DHALL5_PIC32+0)
ORI	R25, R25, lo_addr(?lstr5_Click_3DHALL5_PIC32+0)
JAL	_mikrobus_logWrite+0
NOP	
;Click_3DHALL5_PIC32.c,71 :: 		IntToStr(temp, demoText);
LW	R4, Offset(_temp+0)(GP)
...
JAL	_IntToStr+0
NOP	
;Click_3DHALL5_PIC32.c,72 :: 		mikrobus_logWrite(demoText, _LOG_LINE);
ORI	R26, R0, 2
LUI	R25, hi_addr(_demoText+0)
ORI	R25, R25, lo_addr(_demoText+0)
JAL	_mikrobus_logWrite+0
NOP	
;Click_3DHALL5_PIC32.c,74 :: 		mikrobus_logWrite("  ", _LOG_LINE);
ORI	R26, R0, 2
LUI	R25, hi_addr(?lstr6_Click_3DHALL5_PIC32+0)
ORI	R25, R25, lo_addr(?lstr6_Click_3DHALL5_PIC32+0)
JAL	_mikrobus_logWrite+0
NOP	
;Click_3DHALL5_PIC32.c,75 :: 		Delay_ms( 1000 );
LUI	R24, 406
ORI	R24, R24, 59050
L_applicationTask2:
ADDIU	R24, R24, -1
...
_main:
;Click_3DHALL5_PIC32.c,78 :: 		void main()
;Click_3DHALL5_PIC32.c,80 :: 		systemInit();
JAL	_systemInit+0
NOP	
;Click_3DHALL5_PIC32.c,81 :: 		applicationInit();
JAL	_applicationInit+0
NOP	
;Click_3DHALL5_PIC32.c,83 :: 		while (1)
L_main4:
;Click_3DHALL5_PIC32.c,85 :: 		applicationTask();
JAL	_applicationTask+0
NOP	
;Click_3DHALL5_PIC32.c,86 :: 		}
J	L_main4
NOP	
;Click_3DHALL5_PIC32.c,87 :: 		}
L_end_main:
L__main_end_loop:
J	L__main_end_loop
NOP	
