...
;Click_3DHALL5_DSPIC.c,35 :: 		void systemInit()
;Click_3DHALL5_DSPIC.c,37 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_INT_PIN, _GPIO_INPUT );
	PUSH	W10
	PUSH	W11
	PUSH	W12
	MOV.B	#1, W12
...
;Click_3DHALL5_DSPIC.c,38 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_CS_PIN, _GPIO_OUTPUT );
	CLR	W12
	MOV.B	#2, W11
	CLR	W10
	CALL	_mikrobus_gpioInit
;Click_3DHALL5_DSPIC.c,39 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_AN_PIN, _GPIO_OUTPUT );
	CLR	W12
	CLR	W11
	CLR	W10
	CALL	_mikrobus_gpioInit
;Click_3DHALL5_DSPIC.c,40 :: 		mikrobus_spiInit( _MIKROBUS1, &_C3DHALL5_SPI_CFG[0] );
	MOV	#lo_addr(__C3DHALL5_SPI_CFG), W0
	MOV	W0, W11
	CLR	W10
...
;Click_3DHALL5_DSPIC.c,48 :: 		c3dhall5_spiDriverInit( (T_C3DHALL5_P)&_MIKROBUS1_GPIO, (T_C3DHALL5_P)&_MIKROBUS1_SPI );
	PUSH	W10
	PUSH	W11
	MOV	#lo_addr(__MIKROBUS1_SPI), W11
	MOV	#lo_addr(__MIKROBUS1_GPIO), W10
	CALL	_c3dhall5_spiDriverInit
...
;Click_3DHALL5_DSPIC.c,67 :: 		mikrobus_logWrite(demoText, _LOG_LINE);
	...
	MOV	#lo_addr(_demoText), W10
	CALL	_mikrobus_logWrite
;Click_3DHALL5_DSPIC.c,69 :: 		mikrobus_logWrite("  ", _LOG_LINE);
	MOV.B	#2, W11
	MOV	#lo_addr(?lstr5_Click_3DHALL5_DSPIC), W10
	CALL	_mikrobus_logWrite
;Click_3DHALL5_DSPIC.c,70 :: 		Delay_ms( 1000 );
	MOV	#21, W8
	MOV	#22619, W7
L_applicationTask2:
	DEC	W7
...
;Click_3DHALL5_DSPIC.c,73 :: 		void main()
;Click_3DHALL5_DSPIC.c,75 :: 		systemInit();
	CALL	_systemInit
;Click_3DHALL5_DSPIC.c,76 :: 		applicationInit();
	CALL	_applicationInit
;Click_3DHALL5_DSPIC.c,78 :: 		while (1)
L_main4:
;Click_3DHALL5_DSPIC.c,80 :: 		applicationTask();
	CALL	_applicationTask
;Click_3DHALL5_DSPIC.c,81 :: 		}
	GOTO	L_main4
;Click_3DHALL5_DSPIC.c,82 :: 		}
L_end_main:
L__main_end_loop:
